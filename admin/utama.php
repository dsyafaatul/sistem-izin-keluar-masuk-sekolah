...
<div class="col-md-12">
	<div class="panel panel-primary">
		<div class="panel-heading">
			Statistik jumlah siswa melakukan izin setiap kelas
		</div>
		<div class="panel-body">
			<form action="index.php" method="GET" class="form">
				<div class="form-group">
					<div class="input-group">
						...
						<input type="text" class="form-control input-md" name="range" id="daterangepicker" value="<?php echo (!empty($_GET['range'])?$_GET['range']:date("Y/m/d")."-".date("Y/m/d")) ?>">
						<span class="input-group-btn">
			...
			<div id="barchart" style="width: 50%;margin: 0px auto;"></div>
			<h5 align="center"><?php echo (!empty($_GET['range'])?$_GET['range']:date("Y/m/d")."-".date("Y/m/d")) ?></h5>
		</div>
	</div>
</div>
<?php
